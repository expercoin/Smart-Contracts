 ...
 * For questions about this license contact bigdeeperadvisors@gmail.com
 *
 * For information about Expercoin, Inc. navigate to expercoin.com or e-mail to support@expercoin.com
 *
...
contract RecoverCurrency is AuthorizedList, Authorized {
  ...
  function recoverEther() external ifAuthorized(msg.sender, PRESIDENT) {

    if (msg.sender.call.value(address(this).balance)())
       EtherTransfer(address(this), msg.sender, address(this).balance);
